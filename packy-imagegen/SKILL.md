---
name: packy-imagegen
description: Generate raster images with PackyAPI's Sora-group gpt-image-2 endpoint and save verified PNG or JPEG files locally. Use when the agent needs to create an image through PackyAPI, or when users mention PackyAPI, a Sora image key, gpt-image-2, or the Packy drawing API.
---
...
- Do not persist credentials in this skill.
